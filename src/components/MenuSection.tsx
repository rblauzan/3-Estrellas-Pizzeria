    ...
    <section id="menu" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Nuestras Pizzas Favoritas</h2>
            ...
            >
              <div className="p-4">
                <div className="text-center mb-4">
                  ...
                  />
                  <h3 className="text-lg font-semibold text-gray-800">{pizza.nombre}</h3>
                  <p className="text-sm text-gray-600 mt-2">{pizza.descripcion}</p>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xl font-bold text-red-600">${pizza.precio.toFixed(2)}</span>
                  <PizzaOrderDialog
                    pizza={pizza}
